...
public class c1_Introduction extends IntroductionBase {
    ...
    public void hello_world() {
        ...
        String result = hello_world_service().block(); //todo: change this line only
    ...
    public void empty_service() {
        ...
        Optional<String> optionalServiceResult = emptyService().blockOptional(); //todo: change this line only
    ...
    public void fortune_top_five() {
        ...
        List<String> results = serviceResult.toStream().collect(Collectors.toList()); //todo: change this line only
    ...
    public void leaving_blocking_world_behind() throws InterruptedException {
        ...
        fortuneTop5()
                .subscribe(companyList::add, error -> {}, () -> serviceCallCompleted.set(true))
